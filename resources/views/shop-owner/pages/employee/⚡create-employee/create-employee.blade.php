      ...
      <div class="flex flex-col border border-black dark:border-white rounded-xl p-4 sm:p-6 lg:p-8 bg-gray-200 dark:bg-neutral-800 shadow-2xs">
        ...
        <div class="mb-4">
          <a href="{{ route('shop-owner.employee.view') }}"
            class="inline-flex items-center gap-x-2 px-3 py-2 text-sm font-medium rounded-lg bg-black dark:bg-white dark:bg-black text-white dark:text-black hover:bg-neutral-700 dark:hover:bg-gray-200 focus:outline-hidden">
        ...
        <form wire:submit.prevent='create'>
          <div class="grid gap-4 lg:gap-6">
            ...
            <div>
              ...
              <input wire:model.defer='name' type="text" name="hs-name" id="hs-name"
                class="py-2.5 sm:py-3 px-4 block w-full bg-white dark:bg-black border-black rounded-lg sm:text-sm text-black dark:text-black focus:ring-green-600">
            ...
            <div class="mt-5">
                ...
                <p class="p-3 w-full bg-white dark:bg-black dark:bg-black rounded-lg text-sm text-black dark:text-white">
                    Employee (fixed)
                </p>
            </div>
          </div>
          ...
          <div class="mt-6 grid">
            <button type="submit"
              class="w-50 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-black dark:bg-white dark:bg-black text-white dark:text-black hover:bg-neutral-700 dark:hover:bg-gray-200 focus:outline-hidden">
              Save
            </button>
          </div>
        </form>
