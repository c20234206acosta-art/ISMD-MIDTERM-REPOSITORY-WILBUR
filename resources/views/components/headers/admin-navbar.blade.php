        ...
        <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
            ...
            <nav
                ...
                <div class="lg:hidden mb-2 flex items-center justify-between">
                    ...
                    <!-- Sidebar Toggle -->
                    <button type="button"
                        class="p-1.5 size-7.5 inline-flex items-center gap-x-1 text-xs rounded-md text-white dark:text-black dark:text-blackisabled:pointer-events-none focus:outline-hidden dark:text-neutral-500"
                ...
                <div 
                    ...
                    <span class="block ps-2.5 mb-2 font-medium text-xs uppercase text-white dark:text-black dark:text-black">
                        Home
                    </span>
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-white dark:text-black rounded-lg hover:bg-neutral-700 focus:outline-hidden dark:hover:bg-gray-200"
                ...
                <div
                    ...
                    <ul class="flex flex-col gap-y-1">
                        ...
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-white dark:text-black rounded-lg hover:bg-neutral-700 focus:outline-hidden dark:hover:bg-gray-200"
                                href="{{ route('admin.user.shop-owner') }}">
                                View Shop Owners
                            </a>
                        </li>
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-white dark:text-black rounded-lg hover:bg-neutral-700 focus:outline-hidden dark:hover:bg-gray-200"
                                href="{{ route('admin.user.employee') }}">
                                View Employees
                            </a>
                        </li>
                    </ul>
                ...
                <div
                    ...
                    <ul class="flex flex-col gap-y-1">
                        <li>
                            <a class="w-full flex items-center gap-x-2 py-2 px-2.5 text-sm text-white dark:text-black rounded-lg dark:hover:bg-gray-200 hover:bg-neutral-700 focus:outline-hidden"
                                href="/admin/roles">
                                Roles
                            </a>
                        </li>
