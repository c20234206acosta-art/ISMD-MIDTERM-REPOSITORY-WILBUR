                        ...
                        <div
                            ...
                            <div>
                                <div class="inline-flex gap-x-2">
                                    <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-black dark:bg-white text-white dark:text-black shadow-2xs hover:bg-neutral-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden dark:hover:bg-gray-200 dark:focus:bg-gray-200"
                                        href="#">
                                        View all
                                    </a>

                                    @can('create', Spatie\Permission\Models\Role::class)
                                    <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-black dark:bg-white text-white dark:text-black hover:bg-neutral-700 dark:hover:bg-gray-200 focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none"
